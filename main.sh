...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/BvsshXyz/v1/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/BvsshXyz/izin/main/ipvps"
# USERNAME
rm -f /usr/bin/user
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    # // Setting City&Isp
    mkdir /root/.info;curl -sS "ipinfo.io/org?token=7a814b6263b02c" > 
    /root/.info/.isp;curl -sS "ipinfo.io/city?token=7a814b6263b02c" > 
    /root/.info/.city
